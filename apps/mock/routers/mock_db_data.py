...
from apps.schems.mock_db_data import MockDbScript, SelectLogNum, SearchLog, SelectLog
from apps.curd.db_log_num import get_log_num_status, search_limit, get_db_host, get_time
from apps.public.mock_claim_per_records import mock_db_script, get_db_len
from apps.extensions.pymysql_operation import get_log_data, hget_id
import os
