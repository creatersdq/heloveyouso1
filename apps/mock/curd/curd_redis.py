...
from apps.core.redispool import RedisPoolConnect
...
if __name__ == "__main__":
    ...
    # config1 = json.dumps(read_case_data('cn_ud_test_mock/apps/core/mock_data.yml'))
    # config2 = json.dumps(read_case_data('cn_ud_test_mock/apps/core/ssh_config.yml'))
    # config3 = json.dumps(read_case_data('cn_ud_test_mock/apps/core/mock_db_common.yml'))
    # print(config1)
