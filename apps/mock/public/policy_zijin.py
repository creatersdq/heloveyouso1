...
from apps.curd.db_policy import call_back_policy_no, insurance_code_db, get_claim_data, get_insurance
...
class CsvClass:
    ...
    def taiping_bx(self):
        ...
        with open("/Users/living/PythonPrj/cn_ud_test_mock/apps/public/zijin_policy/{}.csv".format(self.uuid), 'w',
                  encoding="GBK") as f:
            f_csv = csv.writer(f)
        ...
        files = [
            ('files', ('{}.csv'.format(self.uuid),
                       open('/Users/living/PythonPrj/cn_ud_test_mock/apps/public/zijin_policy/{}.csv'.format(self.uuid),
                            'rb'),
  ...
  <ClaimInfo>
    ...
    def file_address_rc(self, uuid):
        ...
        files = [
            ('files', ('{}.csv'.format(uuid),
                       open('/Users/living/PythonPrj/cn_ud_test_mock/apps/public/zijin_claim/{}.csv'.format(uuid),
                            'rb'),
                       'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'))
        ]
        payload = {}
    ...
    def claim_zijin(self):
        ...
        for p in t:
            ...
            with open("/Users/living/PythonPrj/cn_ud_test_mock/apps/public/zijin_claim/{}.csv".format(new_uuid), 'w',
                      encoding="GBK") as f:
                f_csv = csv.writer(f)
                f_csv.writerow(self.headers)
